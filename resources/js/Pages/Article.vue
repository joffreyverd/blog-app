        ...
        <DefaultLayout>
            <header>
                ...
                <div class="flex justify-end gap-4 mb-12">
                    <span class="flex bg-green-100 text-green-800 text-l font-medium px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300">
                        <Bookmark class="w-4 mr-2"/>
                        {{ article.category.name }}
                    </span>
                    <span class="flex bg-blue-100 text-blue-800 text-l font-medium px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">

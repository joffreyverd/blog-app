...
import { Home, Pencil } from 'lucide-vue-next';
import { ref } from 'vue';
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink href="/" :active="route().current('home')" class="flex items-center space-x-2">
                                    <Home class="w-4"/>
                                    <span>Accueil</span>
                                </NavLink>
                                <NavLink :href="route('articles.create')" :active="route().current('articles.create')" class="flex items-center space-x-2">
                                    <Pencil class="w-4"/>
                                    <span>Rédiger</span>
                                </NavLink>
                            </div>
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ms-6">
                            ...
                            <div class="ms-3 relative" v-else>
                                <button
                                    type="button"
                                    class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                                    <Link :href="route('register')">Inscription / Connexion</Link>
                                </button>
                            </div>
                        </div>
